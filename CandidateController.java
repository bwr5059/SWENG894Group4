...
/**	
	   * modifyCandidateByName() - Takes a candidate object and candidate last_name and ,if last_name is found in the database, updates 			candidate
	   * table fields.
	   * @param candidate
	   * @param name
	   * @return
	   */
		@PutMapping("/candidate/modifyCandidateByName/{name}")
		public ResponseEntity<Candidate> modifyCandidateByName(@RequestBody Candidate candidate, @PathVariable String name) {
			
			Candidate currentCandidate = candidateService.findByName(name);
			...
			//Populate currentElection object from submitted object
			currentCandidate.setCanID(currentCandidate.getCanID());
			currentCandidate.setUserID(currentCandidate.getUserID());
			currentCandidate.setFirst_name(candidate.getFirst_name());
			currentCandidate.setLast_name(currentCandidate.getLast_name());
			currentCandidate.setEmail(currentCandidate.getEmail());
			currentCandidate.setElectionID(currentCandidate.getElectionID());
			currentCandidate.setAbout(candidate.getAbout());
			currentCandidate.setEducation(candidate.getEducation());
			currentCandidate.setEmployment(candidate.getEmployment());
			currentCandidate.setExperience(candidate.getExperience());
