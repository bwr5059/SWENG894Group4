...
export default {
  ...
  data: () => {  
    ...
    .then(response => {  
      ...
      this.form.fullname = this.userObj.data.first_name + ' '+ this.userObj.data.last_name
      this.form.fname = this.userObj.data.first_name
      this.form.lname = this.userObj.data.last_name
